...
public class Session {
    ...
    public void saveCurrentAddress(String currentAddress){
    ...
    public void saveManualAddress(String currentAddress){
        editor.putString("manualAddress",currentAddress);
        editor.commit();
    }

    public String getManualAddress(){
        return  prefs.getString("manualAddress","");
    }
